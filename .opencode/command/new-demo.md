...
1. Research the customer (industry/business model) and derive the required Odoo
   apps and the process chain. Determine the demo-data language: derive it from
   the company country unless the user names a language explicitly
...
3. Build: `python3 -m engine.cli generate --spec examples/<customer>.json --out dist`.
